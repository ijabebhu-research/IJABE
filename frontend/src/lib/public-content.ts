...
export type CurrentIssue = Issue & {
...
export const fallbackCurrentIssue: CurrentIssue = {
  ...
  isCurrent: true,
  publications: fallbackPublications.slice(0, 2),
}

export const fallbackArchiveIssues: ArchiveIssue[] = [
  {
...
export const fallbackSiteContent: PublicSiteContent = {
  homepage: {
